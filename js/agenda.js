...
for(var i = 0; i <len;i++){
	$("#agenda_listagem").append("<tr class='agenda_item_lista'>"+
		...
		"<br><td><input type='button' class='btn btn-lg btn-danger' value='X' onclick='agenda_delete(" + results.rows.item(i).id +")'>"
	+"---<input type='button' class='btn btn-lg btn-warning' value='E' onclick='agenda_update_abrir_tela(" + results.rows.item(i).id +")'></td" + "</tr>");
	}
}
